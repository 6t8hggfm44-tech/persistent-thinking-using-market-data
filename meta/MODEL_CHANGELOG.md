...
- Added a **Treasury debt-management / liquidity-support pathway** to the causal graph: buyback policy can affect long-end liquidity, net duration absorption, term premium, and long yields independently of growth or inflation news. The official 10-year CMT fell 4.71%→4.65% and the 30-year 5.28%→5.19% from Aug. 18 to Aug. 19. The timing is consistent with the announcement mattering but does not establish sole causation.
